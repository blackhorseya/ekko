...
var providerSet = wire.NewSet(log.ProviderSet, config.ProviderSet, http.ProviderSet, database.ProviderSet, todo.ProviderSet, restful.ProviderSet, biz.ProviderSet)
