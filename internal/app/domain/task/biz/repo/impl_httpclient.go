...
func (h *httpclient) GetByID(ctx contextx.Contextx, id int64) (info *tm.Ticket, err error) {
	// todo: 2023/4/3|sean|impl me
	panic("implement me")
}

func (h *httpclient) List(ctx contextx.Contextx, condition QueryTicketsCondition) (info []*tm.Ticket, err error) {
	// todo: 2023/4/3|sean|impl me
	panic("implement me")
}

func (h *httpclient) Create(ctx contextx.Contextx, created *tm.Ticket) (info *tm.Ticket, err error) {
	// todo: 2023/4/3|sean|impl me
	panic("implement me")
}
...
func (h *httpclient) Update(ctx contextx.Contextx, updated *tm.Ticket) error {
	// todo: 2023/4/3|sean|impl me
	panic("implement me")
}
