...
func (_m *MockIBiz) ChangeTitle(ctx contextx.Contextx, id primitive.ObjectID, title string) (*entitytodo.Task, error) {
...
func (_m *MockIBiz) Create(ctx contextx.Contextx, title string) (*entitytodo.Task, error) {
...
func (_m *MockIBiz) Delete(ctx contextx.Contextx, id primitive.ObjectID) error {
...
func (_m *MockIBiz) GetByID(ctx contextx.Contextx, id primitive.ObjectID) (*entitytodo.Task, error) {
	ret := _m.Called(ctx, id)
...
func (_m *MockIBiz) List(ctx contextx.Contextx, start int, end int) ([]*entitytodo.Task, int, error) {
...
func (_m *MockIBiz) UpdateStatus(ctx contextx.Contextx, id primitive.ObjectID, status pb.TaskStatus) (*entitytodo.Task, error) {
